...
class Geometry3D(Geometry):
    ...
    def rotate(self, R: ArrayLike, center: ArrayLike = ...) -> Geometry3D: ...
    def scale(self, scale: float, center: ArrayLike) -> Geometry3D: ...
    def transform(self, transformation: ArrayLike) -> Geometry3D: ...
    def translate(self, translation: ArrayLike, relative: bool = True) -> Geometry3D: ...
...
class TriangleMesh(MeshBase):
    ...
    def orient_triangles(self) -> bool: ...
        """
        If the mesh is orientable this function orients all triangles such that all normals point
